...
SCRIPT_PATH = BUNDLE_ROOT / "scripts" / "阈值分析.py"
TARGET_NAME = FIGURE_DIR / "SOA_extreme_exceedance.png"
...
def main() -> None:
    ...
    if not TARGET_NAME.exists():
        raise FileNotFoundError(f"Expected threshold analysis figure missing: {TARGET_NAME}")
    print("Threshold analysis figure generated as PNG.")
